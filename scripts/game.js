...
Game.prototype.setup = function () {
    ...
    for (var i = 0; i < Game.NUMBER_OF_UNITS; i++) {
        this.units.push(Object.create(new Knight(this.createUnitId(), Math.round(utilities.random() * Game.boxesPerRow * Game.boxesPerCol), this.clients[0])));
        this.units.push(Object.create(new Knight(this.createUnitId(), Math.round(utilities.random() * Game.boxesPerRow * Game.boxesPerCol), this.clients[1])));
    }
};
